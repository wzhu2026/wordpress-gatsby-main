...
function handleBtnMouseOver(e) {
  ...
  e.currentTarget.style.boxShadow = heroStyles.btnHover.boxShadow
}

function handleBtnMouseOut(e) {
  e.currentTarget.style.background = heroStyles.btn.background
  e.currentTarget.style.transform = 'scale(1)'
  e.currentTarget.style.boxShadow = heroStyles.btn.boxShadow
}
...
function handleBtnAltMouseOver(e) {
  ...
  e.currentTarget.style.transform = 'scale(1.06)'
  e.currentTarget.style.boxShadow = heroStyles.btnAltHover.boxShadow
}
...
function handleBtnAltMouseOut(e) {
  ...
  e.currentTarget.style.transform = 'scale(1)'
  e.currentTarget.style.boxShadow = heroStyles.btnAlt.boxShadow
}
